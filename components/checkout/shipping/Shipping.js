...
import {
	IoMdArrowDropupCircle, IoIosRemoveCircleOutline,
} from "react-icons/io";
import * as Yup from "yup";

import { countries } from "../../../data/countries";
import {
	changeActiveAddress, deleteAddress, saveAddress,
} from "../../../requests/user";
...
export default function Shipping({ user, addresses, setAddresses, profile }) {
	...
	const {
		firstName, lastName, phoneNumber, state, city, zipCode, address1, address2, country,
	} = shipping;
	...
	return (<div className={styles.shipping}>
		{!profile && (<div className={styles.header}>
			<h3>Shipping Informations</h3>
		</div>)}
		<div className={styles.addresses}>
			{addresses?.map((address) => (<div style={{ position: "relative" }}>
				<div
